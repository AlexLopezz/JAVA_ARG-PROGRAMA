...
public class CarritoTest {
    ...
    class CalculoPrecioTest{
        ...
        void cantidadItemPrecioTest(){
            ...
            double resultadoEsperado = itemCarritos[3].getPrecioFinalItem(); //Tenemos en cuenta el valor del precio total del item 3. (Pan) como resultado esperado.
    ...
    class DescuentoCarritoTest{
        ...
        void DescuentoPorcentajeTest() throws Exception {
            /*
            ...
            * Si el porcentaje es menor a 0, entonces de igual manera el porcentaje de descuento quedara en 0.
            ...
            assertEquals(0, descPorcentaje.getValorDesc()); // Tendria que dar 0 el porcentaje, ya que sobrepasa el precio base.
            descPorcentaje.setValorDesc(-10d);

            assertEquals(0, descPorcentaje.getValorDesc()); //Tambien tendria que quedar en 0, debido a que el porcentaje es menor a 0.
        ...
        void PorcentajeFijoTest() throws Exception {
            int monto = -15;
            DescuentoFijo descuentoFijo = new DescuentoFijo(monto);
            assertEquals(0, descuentoFijo.getValorDesc()); //Tendria que dar 0, debido a que el monto debe ser mayor a 0.

            descuentoFijo.setValorDesc(2000); //Cambiamos el monto fijo.
        ...
        void PorcentajeTopeTest() throws Exception {
            /*
            ...
            * Si queremos cambiar el porcentaje, debemos verificar de cuanto es nuestro tope, ya que si lo sobrepasamos no surgira ningun efecto.
            ...
            descTope.setValorDesc(60d);
            resultado = descTope.getValorDesc();
